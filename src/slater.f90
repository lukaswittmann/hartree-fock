...
subroutine expand_slater(ng, zeta, alpha, coeff)
    ...
    ! write (*,*) 'Expansion of Slater function with zeta =', zeta
    ! write (*,*) '  into', ng, 'primitive gaussians'
    ! write (*,*) '  with exponents:', alpha(:ng)
    ! write (*,*) '  and coefficients:', coeff(:ng)
